...
public:
	...
	{
		Assert( iTeamNum > -1 && iTeamNum < MAX_TEAMS);
...
private:
	float m_aIncursionDistances[ MAX_TEAMS ];
	CUtlVector<CTFNavArea *> m_InvasionAreas[MAX_TEAMS];
...
private:
	...
	CUtlVector< CHandle<CBaseCombatCharacter> > m_PVNPCs[MAX_TEAMS];
