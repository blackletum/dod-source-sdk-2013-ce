...
class CWeaponM3 : public CDODFullAutoPunchWeapon
{
public:
	DECLARE_CLASS( CWeaponM3, CDODFullAutoPunchWeapon );
	...
	virtual DODWeaponID GetWeaponID( void ) const		{ return WEAPON_M3; }
